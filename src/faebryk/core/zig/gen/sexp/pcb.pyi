...
class PtsArc:
    ...
    def __init__(
        self, *, start: Xy, mid: Xy, end: Xy, xys_before: int | None
    ) -> None: ...
    def __repr__(self) -> str: ...
    @staticmethod
    def __field_names__() -> list[str]: ...
...
class Pts:
    ...
    def __zig_address__(self) -> int: ...
    @staticmethod
    def decode(*, arg_0: Allocator, arg_1: SExp) -> Pts: ...
    @staticmethod
    def writeBodyStreamed(*, arg_0: Pts, arg_1: Allocator, arg_3: bool) -> bool: ...
...
def take_unknown_keys() -> list[str]: ...
